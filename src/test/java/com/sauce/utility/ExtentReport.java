...
public class ExtentReport implements ITestListener {
	...
	public void configureReport() {
	   ...
	   //We want to execute configureReport method before all class so we will call this method in on
   ...
   //when TC started then this will invoke for all test cases 
